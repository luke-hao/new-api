	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/aff/rebates", controller.GetAffiliateRebates)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.PUT("/topup/reminder", controller.UpdateWalletRechargeReminder)
				...
				adminRoute.POST("/private_message/broadcast", controller.BroadcastPrivateMessage)
				adminRoute.DELETE("/private_message/broadcast", controller.ClearBroadcastPrivateMessage)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.GET("/group-stability", controller.GetChannelGroupStability)
			channelRoute.PUT("/group-stability", controller.UpdateChannelGroupStability)
			channelRoute.POST("/group-stability/run", controller.RunChannelGroupStability)
			channelRoute.GET("/:id", controller.GetChannel)
			channelRoute.POST("/:id/key", middleware.RootAuth(), middleware.CriticalRateLimit(), middleware.DisableCache(), middleware.SecureVerificationRequired(), controller.GetChannelKey)
			channelRoute.GET("/test", controller.TestAllChannels)
			channelRoute.GET("/test/:id", controller.TestChannel)
			channelRoute.POST("/upstream-billing-probe/:id", controller.ProbeChannelUpstreamBilling)
			channelRoute.GET("/update_balance", controller.UpdateAllChannelsBalance)
			channelRoute.GET("/update_balance/:id", controller.UpdateChannelBalance)
			channelRoute.POST("/", controller.AddChannel)
			channelRoute.PUT("/", controller.UpdateChannel)
			channelRoute.PUT("/group-routing", controller.UpdateChannelGroupRouting)
		...
		tokenRoute.Use(middleware.UserAuth())
		{
			...
			tokenRoute.GET("/metrics", controller.GetTokenMetrics)
			tokenRoute.PUT("/batch/status", controller.UpdateTokenStatusBatch)
		...
		redemptionRoute.Use(middleware.AdminAuth())
		{
			...
			redemptionRoute.DELETE("/batch", controller.DeleteRedemptionsBatch)
