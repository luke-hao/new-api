...
func TestConvertImageRequestStripsResponseFormatForGptImageModels(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
func TestConvertImageEditRequestMultipartDropsResponseFormatForGptImageModels(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	replayedRequest.Header.Set("Content-Type", c.Request.Header.Get("Content-Type"))
	require.NoError(t, replayedRequest.ParseMultipartForm(32<<20))
	require.Empty(t, replayedRequest.PostForm.Get("response_format"))
}

func TestConvertImageEditRequestMultipartDropsPlaygroundGroup(t *testing.T) {
	gin.SetMode(gin.TestMode)
