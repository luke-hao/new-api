...
func (r *GeneralOpenAIRequest) GetTokenCountMeta() *types.TokenCountMeta {
	...
	if maxCompletionTokens > maxTokens {
		tokenCountMeta.MaxTokens = common.BoundedUintToInt(maxCompletionTokens, common.MaxRequestTokens)
	} else {
		tokenCountMeta.MaxTokens = common.BoundedUintToInt(maxTokens, common.MaxRequestTokens)
	}
...
func (r *OpenAIResponsesRequest) GetTokenCountMeta() *types.TokenCountMeta {
	...
	return &types.TokenCountMeta{
		...
		Files:       fileMeta,
		MaxTokens:   common.BoundedUintToInt(lo.FromPtrOr(r.MaxOutputTokens, uint(0)), common.MaxRequestTokens),
	}
}
