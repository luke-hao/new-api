...
func normalizeTokenBatchIDs(ids []int) ([]int, bool) {
	if len(ids) == 0 || len(ids) > maxTokenBatchSize {
		return nil, false
	}
...
func UpdateTokenGroupBatch(c *gin.Context) {
	...
	if !groupUsable {
		common.ApiErrorI18n(c, i18n.MsgTokenGroupUnavailable)
		return
	}
