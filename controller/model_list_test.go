...
func setupModelListControllerTestDB(t *testing.T) *gorm.DB {
	...
	require.NoError(t, db.AutoMigrate(&model.User{}, &model.Channel{}, &model.ChannelGroupRouting{}, &model.ChannelGroupStabilityPolicy{}, &model.ChannelModelRouting{}, &model.ChannelModelStabilityPolicy{}, &model.Ability{}, &model.Model{}, &model.Vendor{}))
