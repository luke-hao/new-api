...
func Distribute() func(c *gin.Context) {
	return func(c *gin.Context) {
					...
					if err == nil && preferred != nil && preferred.Status == common.ChannelStatusEnabled {
						if usingGroup == "auto" && service.HasCustomAutoGroups(c) {
							...
							for _, g := range autoGroups {
								if model.IsChannelEnabledForGroupModel(g, modelRequest.Model, preferred.Id) && !service.IsResponsesChannelCoolingDown(c, g, modelRequest.Model, preferred.Id) {
									selectGroup = g
						...
						} else if model.IsChannelEnabledForGroupModel(usingGroup, modelRequest.Model, preferred.Id) && !service.IsResponsesChannelCoolingDown(c, usingGroup, modelRequest.Model, preferred.Id) {
							channel = preferred
		...
		c.Next()
		if channel != nil && c.Writer != nil && c.Writer.Status() < http.StatusBadRequest && !c.GetBool(service.ResponsesStreamFailedKey) {
