...
export interface GetRedemptionsParams extends RedemptionFilters {
  p?: number
  page_size?: number
}
...
export interface SearchRedemptionsParams extends RedemptionFilters {
  p?: number
  page_size?: number
}

export interface ExportRedemptionsResponse {
  success: boolean
  message?: string
  data?: {
    items: Redemption[]
...
export interface DeleteRedemptionsBatchParams extends RedemptionFilters {
  ids?: number[]
}
