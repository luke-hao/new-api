...
function getMetricModels(data: unknown): PerfModelSummary[] {
  if (!data || typeof data !== 'object') return []
  const models = (data as { data?: { models?: unknown } }).data?.models
...
export function PerformanceOverview() {
  ...
  const models = useMemo(() => getMetricModels(metricsQuery.data), [
    metricsQuery.data,
  ])
