...
const quotaSchema = z.object({
  ...
  AffiliateTopupRebatePercent: z.coerce.number().min(0).max(100),
  TopUpLink: z.string(),
      ...
      <Form {...form}>
        <SettingsForm onSubmit={handleSubmit}>
          ...
          <SettingsFormGrid>
            ...
            <FormField
              control={form.control}
              name='AffiliateTopupRebatePercent'
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('Referral Top-Up Rebate (%)')}</FormLabel>
                  <FormControl>
                    <Input
                      type='number'
                      min={0}
                  ...
                  <FormDescription>
                    {t(
                      'Rebate based on the referral payment amount at payment completion. Set to 0 to disable.'
                    )}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
