...
export type AffiliateRebateHistoryResponse = ApiResponse<AffiliateRebatePage>
...
export type WaffoPancakePaymentResponse = ApiResponse<
  ...
  | string
>
export type WalletRechargeReminderResponse = ApiResponse<{
  enabled: boolean
}>
...
export interface TopupInfo {
  ...
  /** Whether the wallet add-funds area should redirect users to recharge */
  wallet_recharge_reminder_enabled?: boolean
  /** Percentage of successful referral top-ups paid as affiliate rewards */
  affiliate_topup_rebate_percent?: number
}
...
export interface AffiliateRebatePage {
...
/**
 * Wallet recharge reminder switch request (admin only)
 */
export interface WalletRechargeReminderRequest {
  enabled: boolean
}
