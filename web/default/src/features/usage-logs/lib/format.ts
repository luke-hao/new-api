...
/**
 * Map a recorded reasoning effort to a consistent badge color. Unknown values
 * remain visible with a neutral style so future upstream values degrade safely.
 */
