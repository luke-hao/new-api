...
import { VideoPreviewCell } from '../dialogs/video-preview-dialog'
    ...
    createProgressColumn<TaskLog>({ headerLabel: t('Progress') }),
    {
      ...
      cell: function DetailsCell({ row }) {
        ...
        if (isSuccess && isVideoTask && log.task_id) {
          return <VideoPreviewCell taskId={log.task_id} isAdmin={isAdmin} />
        }
        ...
        return (
          <>
            ...
            >
              <Eye className='mt-0.5 size-3.5 shrink-0 text-red-500' />
              <span className='max-h-20 min-w-0 flex-1 overflow-y-auto leading-snug break-words whitespace-normal text-red-600 group-hover:underline dark:text-red-400'>
                {failReason}
              </span>
