...
import {
  ...
  formatResponseTime,
  handleTestChannel,
  updateChannelLastTestErrorInfo,
} from '../../lib'
import type {
  Channel,
  GetChannelsResponse,
...
function createChannelTestCachePatch(
  ...
  if (typeof responseTime !== 'number' || !Number.isFinite(responseTime)) {
    ...
    if (!normalizedErrorCode) return undefined
        ...
        (oldData) => {
          ...
          const nextItems = data.items.map((channel) => {
            ...
            return {
              ...
              other_info: updateChannelLastTestErrorInfo({
                otherInfo: channel.other_info,
                errorCode: patch.errorCode,
                errorMessage: patch.error,
                errorTime: patch.testTime,
              }),
            }
          })
