...
export const STATIC_I18N_KEYS = [
  'channels.modelRouting.allModels',
  'channels.modelRouting.selectModel',
  'channels.modelRouting.overview',
  'channels.modelRouting.started',
  'channels.modelRouting.model',
  'channels.modelRouting.primary',
  'channels.modelRouting.latency',
  'channels.modelRouting.state',
  'channels.modelRouting.last',
  'channels.modelRouting.next',
  'channels.modelRouting.running',
  'channels.modelRouting.paused',
  'channels.modelRouting.noModels',
  'channels.modelRouting.auto',
  'channels.modelRouting.groupPaused',
  'channels.modelRouting.interval',
  'channels.modelRouting.healthySeconds',
  'channels.modelRouting.timeoutSeconds',
  'channels.modelRouting.inherit',
  'channels.modelRouting.price',
  'channels.modelRouting.runModel',
  'channels.modelRouting.runAll',
  'channels.modelRouting.loadFailed',
  'channels.modelRouting.saveFailed',
  'channels.modelRouting.saved',
  'channels.modelRouting.never',
  'channels.modelRouting.healthy',
  'channels.modelRouting.reranked',
  'channels.modelRouting.unchanged',
  'channels.modelRouting.allFailed',
  'channels.modelRouting.noChannels',
  'channels.modelRouting.unsupported',
  'channels.modelRouting.error',
  'channels.modelRouting.unlock',
  'channels.modelRouting.lock',
  'channels.modelRouting.groupLocked',
  'channels.modelRouting.restore',
  'channels.modelRouting.modelOverride',
  'channels.modelRouting.groupDefault',
  'channels.modelRouting.channelDefault',
  'channels.modelRouting.probe.success',
  'channels.modelRouting.probe.failed',
  'channels.modelRouting.probe.timeout',
  'channels.modelRouting.probe.unsupported',
  'channels.modelRouting.groupWeight',
  'Per second',
  // Header navigation
  'Home',
  'Console',
