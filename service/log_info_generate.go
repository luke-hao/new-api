...
func GenerateTextOtherInfo(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, modelRatio, groupRatio, completionRatio float64,
	...
	relayInfo.AppendReasoningInfo(other)
	...
	AppendClaudeThinkingRecoveryAdminInfo(ctx, adminInfo)
...
func appendBillingInfo(relayInfo *relaycommon.RelayInfo, other map[string]interface{}) {
	...
	if relayInfo.PriceData.ImageSizePriceOverride {
		other["image_size_price_override"] = true
		other["image_size_price_tier"] = relayInfo.PriceData.ImageSizePriceTier
	}
